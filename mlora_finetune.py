...
def train(
    ...
    **kwargs,
    ...
    if load_from_checkpoint is not None:
        #checkpoint_path = "/pfs/data6/home/ul/ul_student/ul_swv79/MTLLoRA/Code/MTL-LoRA/output/GLUE/checkpoint/final_checkpoint.pt"
    ...
    if 1 == 9:
        ...
        if data_path.endswith(".json"):  # todo: support jsonl
            ...
            data = data.map(lambda x: {'output': str(x['output'])})
        else:
            data = load_dataset("json", data_files=data_path)
