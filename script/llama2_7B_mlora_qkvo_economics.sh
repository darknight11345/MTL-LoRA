...
#SBATCH --mem=128GB                       # 64 GB RAM for dev_gpu_h100 and 0 for gpu_h100
#SBATCH -t 30:00:00                     # 20 Min Testlauf 
...
DATA_PATH="/pfs/data6/home/ul/ul_student/ul_swv79/MTLLoRA/Code/MTL-LoRA/dataset/economics_code_train_dataset.jsonl"    # .../commonsense_170k_taskid.json
...
OUTPUT_PATH="/pfs/data6/home/ul/ul_student/ul_swv79/MTLLoRA/Code/MTL-LoRA/output/economics"  # Output directory is not used in this script
#/home/ul/ul_student/ul_swv79/MTLLoRA/Code/MTL-LoRA/dataset/economics_code_train_dataset.jsonl
